...
const Hero: React.FC<HeroProps> = ({ onReveal }) => {
  ...
  return (
    <section className="min-h-screen w-full flex flex-col md:flex-row items-center justify-center px-6 md:px-12 py-24 gap-12 md:gap-20 max-w-7xl mx-auto relative overflow-hidden">
      ...
      {/* Text Content */}
      <div className="flex-1 flex flex-col items-center text-center order-2 md:order-1 relative z-10">
        ...
        <div className="flex flex-col items-center space-y-8 w-full max-w-md">
          <button 
            onClick={onReveal}
            className="glass glow-hover group flex flex-col items-center p-8 rounded-3xl transition-all duration-300 w-full border-white/10 relative overflow-hidden text-center"
          >
            ...
            <div className="mt-8 animate-bounce text-cyan-500 relative z-10">
              <i className="fas fa-chevron-down text-xl"></i>
            </div>
          </button>

          <div className="space-y-5 pt-4 w-full">
            <p className="text-slate-300 font-medium tracking-wide flex items-center justify-center gap-4 text-lg">
            ...
            <p className="text-slate-300 font-medium tracking-wide leading-relaxed flex items-center justify-center gap-4 text-lg">
      ...
      {/* Profile Image Side */}
      <div className="flex-1 flex justify-center order-1 md:order-2 relative z-10">
        <div className="relative group">
          ...
          <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full p-2 bg-slate-800/50 border border-white/10 shadow-[0_0_50px_-12px_rgba(6,182,212,0.5)]">
            <img 
              src={profileImageUrl} 
              alt="Ronen Aviram" 
              className="w-full h-full rounded-full border-4 border-slate-900 object-cover grayscale-[10%] group-hover:grayscale-0 transition-all duration-700"
            />
          </div>
        </div>
      </div>
