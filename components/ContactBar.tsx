...
const ContactBar: React.FC = () => {
  return (
    <footer className="sticky bottom-8 w-full px-6 pointer-events-none z-50">
      <div className="max-w-xs mx-auto glass rounded-full px-6 py-3 flex items-center justify-around shadow-2xl pointer-events-auto border border-white/5 animate-fade-in-up">
        {/* LinkedIn - Brand Blue */}
        <a 
        ...
        {/* Email - Multi-colored Gmail Style */}
        <a 
